...
| `GITLAB_RUNNER_PROXY_SOCKS5H_HOST`        | SOCKS5h proxy host for GitLab Runner                                | `proxy-client-socks5h`          |
| `GITLAB_RUNNER_PROXY_SOCKS5H_PORT`        | SOCKS5h proxy port for GitLab Runner                                | `1080`                          |
